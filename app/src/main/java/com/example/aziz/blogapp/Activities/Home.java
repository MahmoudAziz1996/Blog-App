package com.example.aziz.blogapp.Activities;
...
import com.example.aziz.blogapp.Fragments.HomeFragment;
import com.example.aziz.blogapp.Fragments.ProfileFragment;
import com.example.aziz.blogapp.Fragments.SettingsFragment;
...
public class Home extends AppCompatActivity
    ...
    private void iniPopup() {
        ...
        usr_logo=popAddPost.findViewById(R.id.pop_user_img);
        // load Current user profile photo


        Glide.with(this).load(currentUser.getPhotoUrl()).into(usr_logo);
